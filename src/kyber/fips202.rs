 ...
 **************************************************/
     //shake182 rate = 168;
 pub fn shake128_absorb(state: &mut crate::kyber::xof_state::KeccakState, in_data: &[u8]) {
 ...
 **************************************************/
 pub fn shake128_squeezeblocks(out: &mut [u8], nblocks: usize, state: &mut crate::kyber::xof_state::KeccakState) {
